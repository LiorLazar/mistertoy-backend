...
async function emitToUser({ type, data, userId }) {
    ...
    if (socket) {
        loggerService.info(`Emitting event: ${type} to user ${userId} socket [id:${socket.id}]`)
...
// If possible, send to all sockets BUT not the current one
